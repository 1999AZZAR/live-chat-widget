  ...
  (function() {
    ...
    const createWidget = () => {
      ...
      function detectHostTheme() {
        ...
        // This is the most robust method as it reflects what the user actually sees, but can be heavy.
        // It's opt-in via data-advanced-theme attribute on the script tag.
        function getDominantViewportColor() {
          const currentScript = document.currentScript || document.querySelector('script[src*="/widget.js"]');
          const isAdvancedEnabled = currentScript && currentScript.hasAttribute('data-advanced-theme');

          if (!isAdvancedEnabled) {
            // Fallback immediately to lightweight detection if opt-in is not present
