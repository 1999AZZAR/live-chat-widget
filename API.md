...
const iframe = document.createElement('iframe');
iframe.src =
	'https://your-worker.your-account.workers.dev/widget-iframe?' +
	new URLSearchParams({
		theme: 'dark',
...
_This API documentation is subject to change. Please refer to the source code for the most up-to-date details._
...
_This API documentation is maintained alongside the codebase. For the latest updates, please refer to the source repository._
